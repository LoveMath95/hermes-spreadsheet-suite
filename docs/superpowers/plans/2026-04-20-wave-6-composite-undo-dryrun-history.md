...
node --check /root/claude/hermes-spreadsheet-suite/apps/excel-addin/src/taskpane/compositePlan.js
bash -lc 'awk "/<script>/{flag=1;next}/<\\/script>/{flag=0}flag" /root/claude/hermes-spreadsheet-suite/apps/google-sheets-addon/html/Sidebar.js.html > /tmp/hermes-wave6-sidebar.js && node --check /tmp/hermes-wave6-sidebar.js'
bash -lc 'cp /root/claude/hermes-spreadsheet-suite/apps/google-sheets-addon/src/Code.gs /tmp/hermes-wave6-code-gs.js && node --check /tmp/hermes-wave6-code-gs.js'
